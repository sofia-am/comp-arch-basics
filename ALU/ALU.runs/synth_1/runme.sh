...
HD_PWD='C:/Users/sofia/OneDrive/Escritorio/ALU/TP-ARQUITECTURA/ALU/ALU.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log black_box.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source black_box.tcl
